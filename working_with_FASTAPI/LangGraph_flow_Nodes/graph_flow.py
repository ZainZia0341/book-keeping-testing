from All_Nodes_and_Agent import agent, filter_node, generate, generate_finance_answer, check_last_tool, youtube_enhance_node, tools
...
workflow.add_edge("youtube_search_node", "generate")
